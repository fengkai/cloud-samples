...
public class Test {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Class<?> aClass1 = myClassloader1.loadClass("org.apache.dubbo.examples.provider.classloader.namespace.Person");
        Class<?> aClass2 = myClassloader2.loadClass("org.apache.dubbo.examples.provider.classloader.namespace.Person");
